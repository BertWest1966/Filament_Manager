...
function printInventoryA4(kind){
  ...
  <style>
    ...
    *{box-sizing:border-box}
    body{font-family:Arial,sans-serif;color:#000;margin:0;font-size:9pt}
    h1{font-size:17pt;margin:0 0 2mm}
    .meta{display:flex;justify-content:space-between;margin-bottom:5mm;font-size:8.5pt}
    ...
    @media screen{body{padding:12mm;background:#fff}}
  </style></head><body>
    <h1>Filament Manager – ${title}</h1>
    <div class="meta"><span>Afdrukdatum: ${esc(printedAt)}</span><span>Aantal: ${rows.length}</span></div>
    <table><thead><tr><th>Categorie</th><th>Type</th><th>Kleur</th><th>Nummer</th></tr></thead>
