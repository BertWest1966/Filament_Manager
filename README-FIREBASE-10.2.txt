Filament Manager 10.2 - Firebase synchronisatie
================================================

NORMALE WERKING
---------------
1. Open Filament Manager 10.2.
...
LOKALE OPSLAG
--------------
Filament Manager 10.2 gebruikt voor compatibiliteit:
...
NIEUW APPARAAT
--------------
Open dezelfde Filament Manager 10.2-site en meld aan met hetzelfde Firebase-account.
