Filament Manager 10.4 - Firebase synchronisatie
================================================

NORMALE WERKING
---------------
1. Open Filament Manager 10.4.
...
LOKALE OPSLAG
--------------
Filament Manager 10.4 gebruikt voor compatibiliteit:
...
NIEUW APPARAAT
--------------
Open dezelfde Filament Manager 10.4-site en meld aan met hetzelfde Firebase-account.
