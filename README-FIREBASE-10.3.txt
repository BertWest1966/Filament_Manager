Filament Manager 10.3 - Firebase synchronisatie
================================================

NORMALE WERKING
---------------
1. Open Filament Manager 10.3.
...
LOKALE OPSLAG
--------------
Filament Manager 10.3 gebruikt voor compatibiliteit:
...
NIEUW APPARAAT
--------------
Open dezelfde Filament Manager 10.3-site en meld aan met hetzelfde Firebase-account.
